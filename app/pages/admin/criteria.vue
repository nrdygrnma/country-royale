    ...
    >
      <div class="flex-1">
        <h1
          ...
          data-testId="criteria-library-header"
        >
...
const confirmResetDefaults = () => {
  confirmTitle.value = "Reset Library to Defaults";
  confirmMessage.value =
    "Are you sure? This will overwrite your global library with the system defaults. Custom criteria you added manually will be lost.";
  confirmColor.value = "warning";
  onConfirm.value = () => {
    store.resetMasterCriteriaToDefaults();
    toast.add({ title: "Library reset to defaults", color: "success" });
    isConfirmOpen.value = false;
  };
  isConfirmOpen.value = true;
};
